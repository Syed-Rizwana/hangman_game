const wordList = [
    ...
    {
        word: "obfuscate",
        hint: "To confuse or bewilder someone; to make something unclear or obscure."
    },
    {
        word: "perplex",
        hint: "To cause someone to feel completely baffled or puzzled."
    },
    {
        word: "arcane",
        hint: "Known or understood by only a few; mysterious or secret."
    },
    {
        word: "labyrinth",
        hint: "A complex and intricate network of paths or passages; a maze."
    },
    {
        word: "enigmatic",
    ...
    {
        word: "clandestine",
        hint: "Kept secret or done secretly, especially because it is illicit or unauthorized."
    },
    {
        word: "esoteric",
        hint: "Intended for or likely to be understood by only a small number of people with specialized knowledge or interest."
    },
    {
        word: "surreptitious",
    ...
    {
        word: "elusive",
        hint: "Difficult to find, catch, or achieve."
    },
    {
        word: "intrigue",
        hint: "To arouse the curiosity or interest of; to fascinate."
    },
    {
        word: "quizzical",
        hint: "Indicating mild or amused puzzlement."
    }
];
...
const getRandomWord = () => {
    ...
    if (!randomWordObj) {
        console.error("Failed to get a valid word object.");
        return;
    }
...
const initGame = (button, clickedLetter) => {
    if (!currentWord) {
        console.error("Current word is not defined.");
        return;
    }
    ...
    if (currentWord.includes(clickedLetter)) {
        ...
        wrongGuessCount++;
        hangmanImage.classList.add('shake'); // Add shake animation
        setTimeout(() => hangmanImage.classList.remove('shake'), 500); // Remove shake animation
        guessText.innerText = `${wrongGuessCount}/${maxGuesses}`;
